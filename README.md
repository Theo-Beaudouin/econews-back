...
The Back-end will use **Bedrock** and **Wordpress**.
**WP CLI** could be used to quickly create the Custom Post Types, Taxonomies *(and others)* and allow to manage the app directly from the command line.

## Français

**Econews** est une application qui a pour but de partager l'actualité dans le domaine de l'écologie.
Le Back-end utilisera **Bedrock** et **Wordpress**.
**WP CLI** pourrait être utilisé afin de créer plus rapidement les types d'article personnalisables, taxonomies *(et autres)* et permettre de directement gérer l'application depuis l'interface en ligne de commande.
